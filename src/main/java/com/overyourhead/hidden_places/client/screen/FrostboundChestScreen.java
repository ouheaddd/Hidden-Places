...
public class FrostboundChestScreen extends AbstractContainerScreen<FrostboundChestMenu> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(
            HiddenPlacesMod.MOD_ID,
            "textures/gui/container/frostbound_chest.png"
    );

    public FrostboundChestScreen(FrostboundChestMenu menu, Inventory playerInventory, Component title) {
