...
public class MossgateChestScreen extends AbstractContainerScreen<MossgateChestMenu> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(
            HiddenPlacesMod.MOD_ID,
            "textures/gui/container/mossgate_chest.png"
    );

    public MossgateChestScreen(MossgateChestMenu menu, Inventory playerInventory, Component title) {
