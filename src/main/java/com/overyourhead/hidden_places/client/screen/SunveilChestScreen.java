...
public class SunveilChestScreen extends AbstractContainerScreen<SunveilChestMenu> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(
            HiddenPlacesMod.MOD_ID,
            "textures/gui/container/sunveil_chest.png"
    );

    public SunveilChestScreen(SunveilChestMenu menu, Inventory playerInventory, Component title) {
