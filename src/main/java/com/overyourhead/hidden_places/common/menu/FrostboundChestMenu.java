...
public class FrostboundChestMenu extends AbstractContainerMenu {
    ...
    public FrostboundChestMenu(int containerId, Inventory playerInventory) {
        this(containerId, playerInventory, new SimpleContainer(CHEST_SLOT_COUNT), ContainerLevelAccess.NULL);
    }

    public FrostboundChestMenu(int containerId, Inventory playerInventory, Container container, ContainerLevelAccess access) {
        super(HPMenuTypes.FROSTBOUND_CHEST.get(), containerId);
    ...
    public boolean stillValid(Player player) {
        return stillValid(this.access, player, HPBlocks.FROSTBOUND_CHEST.get());
    }
