...
public class MossgateChestMenu extends AbstractContainerMenu {
    ...
    public MossgateChestMenu(int containerId, Inventory playerInventory) {
        this(containerId, playerInventory, new SimpleContainer(CHEST_SLOT_COUNT), ContainerLevelAccess.NULL);
    }

    public MossgateChestMenu(int containerId, Inventory playerInventory, Container container, ContainerLevelAccess access) {
        super(HPMenuTypes.MOSSGATE_CHEST.get(), containerId);
    ...
    public boolean stillValid(Player player) {
        return stillValid(this.access, player, HPBlocks.MOSSGATE_CHEST.get());
    }
