...
public class WildrootChestMenu extends AbstractContainerMenu {
    ...
    public WildrootChestMenu(int containerId, Inventory playerInventory) {
        this(containerId, playerInventory, new SimpleContainer(CHEST_SLOT_COUNT), ContainerLevelAccess.NULL);
    }

    public WildrootChestMenu(int containerId, Inventory playerInventory, Container container, ContainerLevelAccess access) {
        super(HPMenuTypes.WILDROOT_CHEST.get(), containerId);
    ...
    public boolean stillValid(Player player) {
        return stillValid(this.access, player, HPBlocks.WILDROOT_CHEST.get());
    }
